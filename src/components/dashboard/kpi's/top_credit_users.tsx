...
import { TbChevronRight, TbChartBar } from "react-icons/tb";
    ...
    useEffect(() => {
        ...
        const loadTopUsers = async () => {
            ...
            setOptions({
                ...
                fill: {
                    type: 'solid',
                    colors: ["#ea4335", "#fbbc04", "#34a853", "#4285f4", "#1a73e8"]
                },
                series: [
                    {
                        name: "Usage",
                        data: seriesData, // Only standard color fills
                    },
                ],
            });
        };
        ...
        <div className="relative h-60 w-full min-w-80 rounded-sm bg-white border border-gray-300 shadow-sm p-5 flex flex-col justify-between">
            <div className="flex items-center justify-between mb-4 relative z-10 w-full">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-sm font-bold text-slate-800 capitalize">Top Consumers</h2>
                        <p className="text-xs text-slate-500 font-medium">Highest credit utilization</p>
                    </div>
                </div>

                <div className="flex items-center gap-1 text-[#1a73e8] bg-blue-50 px-2 py-1 rounded border border-blue-100 cursor-pointer hover:bg-blue-100 transition-colors">
